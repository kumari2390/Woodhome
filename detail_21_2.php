...
?>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          <div class="price-box">
                            ...
                            <span id="price-strike" class="price-strike">₹
                        ...
                        <div class="col-sm-2">
                          <div class="cart-quantity">
                            <div class="quant-input">
                              <input id="quantity" onchange="price_change(<?php echo $productId;?>);" type="number" value="1">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-3">
                          <div class="cart-quantity">
                            <div class="quant-input" style="width:100%">
                              <select id="size" onchange="price_change(<?php echo $productId;?>)" class="form-control" style="border-radius:0;width:100%">
                  ...
                  <div class="products">
                    <div class="product">		
                      <div class="product-image">
                        <div class="image">
                          <a href="detail.php?product=<?php echo base64_encode($s['product_id']);?>">
    ...
    <script type="text/javascript">
      function price_change(pid)
      {
        var qty = $('#quantity').val();
        var size = $('#size').val();
        // alert(qty+"---"+size);
        // $('#price').html("₹"+qty);
        // $('#price-strike').html("₹"+size);
        var datas = "product="+btoa(pid)+"&quantity="+qty+"&size="+size;
        //alert(datas);
        $.ajax({
          type: "POST",
          url: "get_prices.php",
      ...
      function add_to_cart(pid)
      {
        ...
        var size = $('#size').val();
        var datas = "product="+btoa(pid)+"&quantity="+quantity+"&size="+size;
        //alert(datas);
        $.ajax({
          type: "POST",
          url: "add_to_cart.php",
