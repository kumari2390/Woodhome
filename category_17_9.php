        ...
        <div class="sidebar-module-container">
          <div class="sidebar-filter"> 
            ...
            <div class="sidebar-widget wow fadeInUp">
              ...
              <div class="sidebar-widget-body">
                <ul class="list">
                  <li><a href="#">Arvind Parekh</a></li>
                  <li><a href="#">Maneklal </a></li>
            ...
            <div class="home-banner"> <img src="assets/images/2.jpg" alt="Image"> </div>
          </div>
          <!-- /.sidebar-filter --> 
        </div>
                ...
                <div class="row">
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.php"><img  src="assets/images/1.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.php">Fresh Corn 1 PC</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> ₹ 12 </span> <span class="price-before-discount">₹ 15</span> </div>
                          <!-- /.product-price --> 
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.php"><img  src="assets/images/2.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.php">Fresh Potato 1 KG</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> ₹40 </span> <span class="price-before-discount">₹ 45</span> </div>
                          <!-- /.product-price --> 
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.php"><img  src="assets/images/3.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.php">Fresh Brinjal 1 KG</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> ₹45 </span> <span class="price-before-discount">₹ 49</span> </div>
                          <!-- /.product-price --> 
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.php"><img  src="assets/images/4.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.php">Fresh Cabbage 1 KG</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> ₹45 </span> <span class="price-before-discount">₹ 60</span> </div>
                          <!-- /.product-price --> 
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.php"><img  src="assets/images/5.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.php">Fresh Lemon 1KG </a></h3> 
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> ₹45 </span> <span class="price-before-discount">₹ 80</span> </div>
                          <!-- /.product-price --> 
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.php"><img  src="assets/images/6.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.php">Fresh Coliflower</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> ₹20 </span> <span class="price-before-discount">₹ 20</span> </div>
                          <!-- /.product-price --> 
                    ...
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          ...
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> ₹12 </span> <span class="price-before-discount">₹ 20</span> </div>
                          <!-- /.product-price --> 
